...
model_ws = os.path.join('modflow', 'HTC', 'Navarro', 'SteadyState', 'SFR', model_prefix+'0')
...
## copy launch script
shutil.copy2(os.path.join('modflow', 'HTC', 'Navarro', 'SteadyState', 'SFR', 'launch_thisRun.sh'), model_ws)
...
for w in range(0,iwel.shape[0]):
    ...
    w_model_ws = os.path.join('modflow', 'HTC', 'Navarro', 'SteadyState', 'SFR', model_prefix+str(WellNum))
    ...
    path_nam_template = os.path.join('modflow', 'HTC', 'Navarro', 'SteadyState', 'SFR', modelname+'_Template.nam')
