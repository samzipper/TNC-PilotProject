...
if (Sys.info()["nodename"] == "GHPC117"){
  ...
  dir.TNC <- paste0("C:/Users/", Sys.info()["user"], "/OneDrive/OneDrive - The University of Kansas/Research/StreamflowDepletion/TNC-PilotProject/ProprietaryStuffFromTNC")
}
